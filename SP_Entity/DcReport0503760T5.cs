...
namespace SP_Entity
{
    public partial class DcReport0503760T5
    {
        public DcReport0503760T5()
        {
            FsS5T50503760List = new HashSet<FsS5T50503760List>();
        }
        ...
        public virtual ICollection<FsS5T50503760List> FsS5T50503760List { get; set; }
    }
}
