...
namespace SP_Entity
{
    public partial class HArpf0503295
    {
        public HArpf0503295()
        {
            HfsRfTab0503295aList = new HashSet<HfsRfTab0503295aList>();
        }
        ...
        public virtual ICollection<HfsRfTab0503295aList> HfsRfTab0503295aList { get; set; }
    }
}
