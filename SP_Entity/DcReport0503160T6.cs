...
namespace SP_Entity
{
    public partial class DcReport0503160T6
    {
        public DcReport0503160T6()
        {
            FsS5T60503160List = new HashSet<FsS5T60503160List>();
        }
        ...
        public virtual ICollection<FsS5T60503160List> FsS5T60503160List { get; set; }
    }
}
