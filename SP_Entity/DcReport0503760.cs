...
namespace SP_Entity
{
    public partial class DcReport0503760
    {
        ...
        public string HrOkpobodyactfounder { get; set; }
        ...
        public string CntrlzdacctgLeader { get; set; }
        public string CntrlzdacctgExecutor { get; set; }
        public string CntrlzdacctgPostLeader { get; set; }
