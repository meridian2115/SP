...
namespace SP_Entity
{
    public partial class DcRpReport0507062
    {
        public DcRpReport0507062()
        {
            FsT10507062List = new HashSet<FsT10507062List>();
            FsT20507062List = new HashSet<FsT20507062List>();
            FsT30507062List = new HashSet<FsT30507062List>();
            FsT40507062List = new HashSet<FsT40507062List>();
        }
        ...
        public virtual ICollection<FsT10507062List> FsT10507062List { get; set; }
        public virtual ICollection<FsT20507062List> FsT20507062List { get; set; }
        public virtual ICollection<FsT30507062List> FsT30507062List { get; set; }
        public virtual ICollection<FsT40507062List> FsT40507062List { get; set; }
    }
}
