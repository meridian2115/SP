...
namespace SP_Entity
{
    public partial class DcReport0503160T4
    {
        public DcReport0503160T4()
        {
            FsS4T40503160List = new HashSet<FsS4T40503160List>();
        }
        ...
        public virtual ICollection<FsS4T40503160List> FsS4T40503160List { get; set; }
    }
}
