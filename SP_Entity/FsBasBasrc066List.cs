...
namespace SP_Entity
{
    public partial class FsBasBasrc066List
    {
        ...
        public string Numbmf { get; set; }
        public string Accnumbfc { get; set; }
