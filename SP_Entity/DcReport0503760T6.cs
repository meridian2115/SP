...
namespace SP_Entity
{
    public partial class DcReport0503760T6
    {
        public DcReport0503760T6()
        {
            FsS5T60503760List = new HashSet<FsS5T60503760List>();
        }
        ...
        public virtual ICollection<FsS5T60503760List> FsS5T60503760List { get; set; }
    }
}
