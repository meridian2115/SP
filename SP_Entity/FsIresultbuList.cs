...
namespace SP_Entity
{
    public partial class FsIresultbuList
    {
        ...
        public DateTime? DoDocDate { get; set; }
        ...
        public virtual DcArpFahBuposting Doc { get; set; }
    }
}
