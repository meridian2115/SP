...
namespace SP_Entity
{
    public partial class DcArpf0503296
    {
        public DcArpf0503296()
        {
            FsRf0503296aList = new HashSet<FsRf0503296aList>();
            FsTIm0503074List = new HashSet<FsTIm0503074List>();
        }
        ...
        public virtual ICollection<FsRf0503296aList> FsRf0503296aList { get; set; }
        public virtual ICollection<FsTIm0503074List> FsTIm0503074List { get; set; }
    }
}
