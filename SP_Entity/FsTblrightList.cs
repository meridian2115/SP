...
namespace SP_Entity
{
    public partial class FsTblrightList
    {
        ...
        public string T2r1 { get; set; }
        public string T2r2 { get; set; }
        public string T2r3 { get; set; }
        public string T2r4 { get; set; }
        public string T2r5 { get; set; }
        public string T2r6 { get; set; }
        public string T2r7 { get; set; }
        public string T2r8 { get; set; }
        public string T2r9 { get; set; }
        public string T2r10 { get; set; }
        public string T2r11 { get; set; }
