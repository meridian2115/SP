...
namespace SP_Entity
{
    public partial class FsBe0503121List
    {
        public FsBe0503121List()
        {
            FsBeDet0503121List = new HashSet<FsBeDet0503121List>();
        }
        ...
        public virtual ICollection<FsBeDet0503121List> FsBeDet0503121List { get; set; }
    }
}
