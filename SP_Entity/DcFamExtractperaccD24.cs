...
namespace SP_Entity
{
    public partial class DcFamExtractperaccD24
    {
        public DcFamExtractperaccD24()
        {
            FsFilelistD24List = new HashSet<FsFilelistD24List>();
            FsStrvippdD24List = new HashSet<FsStrvippdD24List>();
            FsStrvippdinvD24List = new HashSet<FsStrvippdinvD24List>();
        }

        public decimal Docid { get; set; }
        public decimal? Version { get; set; }
        public string BreAccnum { get; set; }
        public string BreBik { get; set; }
        public string BreExtrtype { get; set; }
        public string BreExtrname { get; set; }
        public string BreExtrstatus { get; set; }
        public string BreAcctype { get; set; }
        public string BreBankname { get; set; }
        public string BreTofkname { get; set; }
        public string BreTofkcode { get; set; }
        public bool? BrePerehodrr { get; set; }
        public string BreTehpole { get; set; }
        public string BreCurrorg { get; set; }
        public DateTime? BreDocdate { get; set; }
        public string BreDocnum { get; set; }
        public string BreFilename { get; set; }
        public string BreDocguid { get; set; }
        public decimal? KsuIncbal { get; set; }
        public decimal? KsuOutbal { get; set; }
        public DateTime? DbvAbstractdate { get; set; }
        public DateTime? DbvLastmovetdate { get; set; }
        public DateTime? DbvBegintime { get; set; }
        public DateTime? DbvEndtime { get; set; }
        public decimal? SssSizelimcr { get; set; }
        public decimal? SssReservedsum { get; set; }
        public string VrvEdno { get; set; }
        public string VrvEdreceiver { get; set; }
        public string VrvEdauthor { get; set; }
        ...
        public decimal? PvpObdb { get; set; }
        public decimal? PvpObcr { get; set; }
        public decimal? PvpChisstrdb { get; set; }
        public decimal? PvpChisstrcr { get; set; }
        public decimal? SpdObdb { get; set; }
        public decimal? SpdObcr { get; set; }
        public decimal? SpdChisstrdb { get; set; }
        public decimal? SpdChisstrcr { get; set; }
        public decimal? RazObdb { get; set; }
        public decimal? RazObcr { get; set; }
        public decimal? RazChisstrdb { get; set; }
        public decimal? RazChisstrcr { get; set; }
        public decimal? SysSumdb { get; set; }
        public string BreCurrcode { get; set; }
        public decimal? KsuIncbalrur { get; set; }
        public decimal? KsuOutbalrur { get; set; }
        public decimal? SpsObdbs { get; set; }
        public decimal? SpsObcrs { get; set; }
        public decimal? SpsObdbss { get; set; }
        public decimal? SpsObcrss { get; set; }
        public decimal? SpsObdbnos { get; set; }
        public decimal? SpsObcrnos { get; set; }
        public string BreVerifiedextr { get; set; }
        public decimal? PvpObdbval { get; set; }
        public decimal? PvpObcrval { get; set; }
        public decimal? SpnObdb { get; set; }
        public decimal? SpnObcr { get; set; }
        public decimal? SpnChisstrdb { get; set; }
        public decimal? SpnChisstrcr { get; set; }
        public decimal? RazObdbval { get; set; }
        public decimal? RazObcrval { get; set; }
        public decimal? SpdObdbval { get; set; }
        public decimal? SpdObcrval { get; set; }
        public decimal? SpnObdbvnbv { get; set; }
        public decimal? SpnObcrvnbv { get; set; }
        public DateTime? Dtload { get; set; }
        public string BreYear { get; set; }
        public decimal? SysSumcr { get; set; }
        ...
        public string P1ImpPath { get; set; }
        public string P1Periodtype { get; set; }
        public string BreInnRasp { get; set; }
        public decimal? KsuIncbalD { get; set; }
        public decimal? KsuIncbalrurD { get; set; }
        public decimal? KsuOutbalD { get; set; }
        public decimal? KsuOutbalrurD { get; set; }

        public virtual ICollection<FsFilelistD24List> FsFilelistD24List { get; set; }
        public virtual ICollection<FsStrvippdD24List> FsStrvippdD24List { get; set; }
        public virtual ICollection<FsStrvippdinvD24List> FsStrvippdinvD24List { get; set; }
    }
}
