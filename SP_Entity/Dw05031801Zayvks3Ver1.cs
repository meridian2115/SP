...
namespace SP_Entity
{
    public partial class Dw05031801Zayvks3Ver1
    {
        ...
        public string Gaif { get; set; }
        public string KodVnutr { get; set; }
        public string KodVnesh { get; set; }
        public string Dim1 { get; set; }
        public string Dim2 { get; set; }
        public string Dim3 { get; set; }
        public string Dim4 { get; set; }
        public DateTime? Dim5 { get; set; }
