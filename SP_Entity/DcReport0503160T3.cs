...
namespace SP_Entity
{
    public partial class DcReport0503160T3
    {
        public DcReport0503160T3()
        {
            FsS3T30503160List = new HashSet<FsS3T30503160List>();
        }
        ...
        public virtual ICollection<FsS3T30503160List> FsS3T30503160List { get; set; }
    }
}
