...
namespace SP_Entity
{
    public partial class FsTab0507022List
    {
        ...
        public string Xand0 { get; set; }
        public string Arif2 { get; set; }
        public decimal? CopyV { get; set; }

        public virtual DcArpReport0507022 Doc { get; set; }
    }
}
