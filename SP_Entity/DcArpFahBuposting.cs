...
namespace SP_Entity
{
    public partial class DcArpFahBuposting
    {
        public DcArpFahBuposting()
        {
            FsIresultbuList = new HashSet<FsIresultbuList>();
        }
        ...
        public virtual ICollection<FsIresultbuList> FsIresultbuList { get; set; }
    }
}
