...
namespace SP_Entity
{
    public partial class DcArpPrtcolbdc
    {
        public DcArpPrtcolbdc()
        {
            FsTableErrorsList = new HashSet<FsTableErrorsList>();
        }
        ...
        public virtual ICollection<FsTableErrorsList> FsTableErrorsList { get; set; }
    }
}
