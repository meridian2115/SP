...
namespace SP_Entity
{
    public partial class DcReport0503160T1
    {
        public DcReport0503160T1()
        {
            FsS1T10503160List = new HashSet<FsS1T10503160List>();
        }
        ...
        public virtual ICollection<FsS1T10503160List> FsS1T10503160List { get; set; }
    }
}
