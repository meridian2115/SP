...
namespace SP_Entity
{
    public partial class DcReport0503160T2
    {
        public DcReport0503160T2()
        {
            FsS2T20503160List = new HashSet<FsS2T20503160List>();
        }
        ...
        public virtual ICollection<FsS2T20503160List> FsS2T20503160List { get; set; }
    }
}
