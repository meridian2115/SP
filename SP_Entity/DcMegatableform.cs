...
namespace SP_Entity
{
    public partial class DcMegatableform
    {
        public DcMegatableform()
        {
            FsApprovalList = new HashSet<FsApprovalList>();
            FsRplApprReplList = new HashSet<FsRplApprReplList>();
            FsRplChfReplList = new HashSet<FsRplChfReplList>();
            FsRplLdrFesReplList = new HashSet<FsRplLdrFesReplList>();
            FsRplLdrReplList = new HashSet<FsRplLdrReplList>();
            FsSignChfList = new HashSet<FsSignChfList>();
            FsSignLdrCaList = new HashSet<FsSignLdrCaList>();
            FsSignLdrFesList = new HashSet<FsSignLdrFesList>();
            FsSignLdrList = new HashSet<FsSignLdrList>();
            FsSignOipList = new HashSet<FsSignOipList>();
            FsStatctrlsHstryList = new HashSet<FsStatctrlsHstryList>();
            FsSupermegatableList = new HashSet<FsSupermegatableList>();
        }
        ...
        public virtual ICollection<FsApprovalList> FsApprovalList { get; set; }
        public virtual ICollection<FsRplApprReplList> FsRplApprReplList { get; set; }
        public virtual ICollection<FsRplChfReplList> FsRplChfReplList { get; set; }
        public virtual ICollection<FsRplLdrFesReplList> FsRplLdrFesReplList { get; set; }
        public virtual ICollection<FsRplLdrReplList> FsRplLdrReplList { get; set; }
        public virtual ICollection<FsSignChfList> FsSignChfList { get; set; }
        public virtual ICollection<FsSignLdrCaList> FsSignLdrCaList { get; set; }
        public virtual ICollection<FsSignLdrFesList> FsSignLdrFesList { get; set; }
        public virtual ICollection<FsSignLdrList> FsSignLdrList { get; set; }
        public virtual ICollection<FsSignOipList> FsSignOipList { get; set; }
        public virtual ICollection<FsStatctrlsHstryList> FsStatctrlsHstryList { get; set; }
        public virtual ICollection<FsSupermegatableList> FsSupermegatableList { get; set; }
    }
}
