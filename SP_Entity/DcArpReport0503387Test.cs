...
namespace SP_Entity
{
    public partial class DcArpReport0503387Test
    {
        public DcArpReport0503387Test()
        {
            FsTab0503387List = new HashSet<FsTab0503387List>();
        }
        ...
        public virtual ICollection<FsTab0503387List> FsTab0503387List { get; set; }
    }
}
