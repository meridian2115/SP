...
namespace SP_Entity
{
    public partial class DcArpPrt0503120
    {
        public DcArpPrt0503120()
        {
            FsRepVnk120List = new HashSet<FsRepVnk120List>();
            FsT01Vnk120List = new HashSet<FsT01Vnk120List>();
        }
        ...
        public virtual ICollection<FsRepVnk120List> FsRepVnk120List { get; set; }
        public virtual ICollection<FsT01Vnk120List> FsT01Vnk120List { get; set; }
    }
}
