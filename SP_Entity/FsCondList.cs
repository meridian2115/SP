...
namespace SP_Entity
{
    public partial class FsCondList
    {
        public decimal Fieldsetid { get; set; }
        public decimal? Tablerownum { get; set; }
        public decimal? FsDictListid { get; set; }
        ...
        public string SourceCodeExpSet { get; set; }
        public string SourceCodeNameExp { get; set; }
        public string SourceCodeNameExpCmbox { get; set; }
        ...
        public virtual FsDictList FsDictList { get; set; }
    }
}
