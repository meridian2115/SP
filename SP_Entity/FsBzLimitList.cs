...
namespace SP_Entity
{
    public partial class FsBzLimitList
    {
        public decimal Fieldsetid { get; set; }
        public decimal? Tablerownum { get; set; }
        public decimal? FsBzColumnListid { get; set; }
        ...
        public decimal? NumppCopy { get; set; }
        public string DateSetCodeCopy { get; set; }
        public string SourceCodeSetCopy { get; set; }

        public virtual FsBzColumnList FsBzColumnList { get; set; }
    }
}
